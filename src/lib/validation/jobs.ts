...
export const jobCreateSchema = z
  ...
  .refine(
    ...
    {
      message:
        'Source requirements not met: upload requires document_id, url requires source_url, s3 requires source_key',
      path: ['source'],
    }
  );
...
export const jobQuerySchema = paginationParamsSchema
  .extend({
