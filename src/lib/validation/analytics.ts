...
export const analyticsQuerySchema = z
  .object({
    ...
    end_date: z
      ...
      .optional(),
    document_type: z.string().max(100, 'Document type must be 100 characters or less').optional(),
  })
  .strict()
  .refine(
    data => {
    ...
    {
      message:
        'Both start_date and end_date must be provided together, and start_date must be before or equal to end_date',
      path: ['start_date'],
    }
  );
...
export const accuracyBreakdownItemSchema = z
  .object({
...
export const errorRateItemSchema = z
  .object({
    error_type: z.string(),
