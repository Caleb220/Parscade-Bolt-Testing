...
type UpdateNotificationPreferencesRequest =
  paths['/v1/notifications/preferences']['put']['requestBody']['content']['application/json'];
type UpdateNotificationPreferencesResponse =
  paths['/v1/notifications/preferences']['put']['responses']['200']['content']['application/json'];
...
export const notificationsApi = {
  ...
  async updatePreferences(
    ...
    return await apiClient.put<UpdateNotificationPreferencesResponse>(
