...
export const notificationsApi = {
  ...
  async getPreferences(): Promise<NotificationPreferences> {
    return apiClient.get<GetNotificationPreferencesResponse>('/v1/notifications/preferences');
  },
  ...
  async updatePreferences(updates: NotificationPreferencesUpdate): Promise<NotificationPreferences> {
    return apiClient.put<UpdateNotificationPreferencesResponse>('/v1/notifications/preferences', updates);
  },
} as const;