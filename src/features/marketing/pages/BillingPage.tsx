        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <p className="text-gray-600 mt-1">
              Future pricing plans - currently in beta development
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              We're still in beta, but here's our planned pricing structure. Beta users get special
                    ...
                    >
                      ...
                      <div className="text-center mb-8">
                        ...
                        <div className="flex items-baseline justify-center mb-4">
                          ...
                          <span className="text-gray-600 ml-1">
                            {plans[activeCardIndex].period}
                          </span>
                        </div>
                        <p className="text-lg text-gray-600">
                          {plans[activeCardIndex].description}
                        </p>
                      </div>
                      ...
                      <div className="mt-8 max-w-xs mx-auto w-full">
                        <CustomButton
                          ...
                          fullWidth
                        >
                          {plans[activeCardIndex].name === 'Enterprise'
                            ? 'Contact Us'
                            : 'Join Beta'}
                        </CustomButton>
                      </div>
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 z-10">
                      <div className="bg-blue-600 text-white px-3 py-1 mt-3 rounded-full text-xs font-medium whitespace-nowrap flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Targeting sub-second processing with cloud-native architecture
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Building with enterprise security and compliance from day one
                </p>
              </div>
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Beta Program FAQ</h3>
              ...
              {[
                {
                  ...
                  answer:
                    'Beta users get early access to our platform, direct feedback channels with our team, and special pricing when we launch.',
                },
                {
                  question: 'When will the full platform launch?',
                  answer:
                    "We're targeting a full launch in 2025. Beta users will be the first to know and get priority access.",
                },
                {
                  question: 'How can I influence the product?',
                  answer:
                    'Beta users have direct access to our product team and can request features, report issues, and shape our roadmap.',
                },
                {
                  question: 'What are the beta requirements?',
                  answer:
                    'Just enthusiasm for better document processing! We welcome feedback from users of all technical levels.',
                },
              ].map((faq, index) => (
                <div key={index}>
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Join our beta program</h3>
            <p className="text-gray-600 mb-8">
              Be among the first to experience the future of document processing. Help us build
              something amazing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto sm:max-w-none">
              <CustomButton size="lg">Join Beta Program</CustomButton>
