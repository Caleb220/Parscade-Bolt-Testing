        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                We're building the next generation of document processing. Our intelligent parsing
                platform will automatically extract, structure, and deliver data from any document
                format with unprecedented accuracy.
              </motion.p>
