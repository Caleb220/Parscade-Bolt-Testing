  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Need Help Signing In?</h1>
        <p className="text-gray-600 mb-6">
          Password reset is currently unavailable. For assistance with your account, please contact
          our support team.
        </p>
        ...
        <p className="text-xs text-gray-500 mt-4">Response time: Within 24 hours</p>
      </div>
    </div>
  );
};
