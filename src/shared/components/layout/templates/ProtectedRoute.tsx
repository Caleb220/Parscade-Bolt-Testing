 ...
 */
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children, redirectTo = PATHS.HOME }) => {
  ...
  React.useEffect(() => {
    ...
    const addNoCacheHeaders = () => {
      ...
      const existingTags = document.querySelectorAll(
        'meta[http-equiv="Cache-Control"], meta[http-equiv="Pragma"], meta[http-equiv="Expires"]'
      );
